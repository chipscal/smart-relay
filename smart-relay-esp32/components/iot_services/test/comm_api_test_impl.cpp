...
void comm_api_test_impl() {
    ...
    auto rule0 = clab::iot_services::unary_rule_t<8>("d[0]=1,12345678");
    ...
    auto rule1 = clab::iot_services::unary_rule_t<8>("v[2]=1.33,12345678");
    ...
    auto combined0 = clab::iot_services::combined_rule_t<4, 8>("{d[12]=1,12345678;v[2]=1.33,12345678;;}r0");
