...
void comm_api_test_impl() {
    ...
    auto rule0 = clab::iot_services::unary_rule_t<8>("d0=1,12345678");
    ...
    auto rule1 = clab::iot_services::unary_rule_t<8>("v2=1.33,12345678");
    ...
    auto combined0 = clab::iot_services::combined_rule_t<3, 8>("[d0=1,12345678;v2=1.33,12345678;;]r0");
    TEST_ASSERT(combined0.rules[0].port.type == clab::iot_services::port_type_t::DIGITAL);
    TEST_ASSERT(combined0.rules[0].port.index == 0);
