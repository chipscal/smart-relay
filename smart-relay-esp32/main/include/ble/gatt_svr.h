...
//These are the transfer request process methods. 
/*
PC                        OTA
|   --Request OTA ---->    | 
|   <--Request ACK/NAK --  |
...
extern "C" {
#endif
  /// @brief Starts the services, Adjusts a host configuration object's settings to accommodate the specified service definition array, queues the svrs.
  void gatt_svr_init();
#if __cplusplus
}
#endif
